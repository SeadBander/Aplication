...
CREATE TABLE `loan_application` (
  ...
  KEY `fk_loan_application_users_idx` (`user_id`),
  CONSTRAINT `fk_loan:application_product` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  CONSTRAINT `fk_loan_application_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
INSERT INTO `loan_application` VALUES (1,1);
...
INSERT INTO `privilege` VALUES (1,'administrator'),(2,'user');
...
CREATE TABLE `products` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_products_users_idx` (`applicant`),
  CONSTRAINT `fk_products_users` FOREIGN KEY (`applicant`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `products` VALUES (1,'Kredit',10000,1);
...
INSERT INTO `town` VALUES (1,'Sarajevo',1);
...
-- Dump completed on 2022-08-30 11:33:19
